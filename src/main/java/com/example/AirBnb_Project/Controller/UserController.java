...
import com.example.AirBnb_Project.Service.GuestService;
...
//        @Operation(summary = "Update the user profile", tags = {"Profile"})
        public ResponseEntity<Void> updateProfile(@RequestBody ProfileUpdateReqDto profileUpdateReqDto) {
            userService.updateProfile(profileUpdateReqDto);
